...
(function () {
    ...
    function PreregService(TokenRestangular, $translate) {
        var service = {
            ...
            confirmedBusiness : confirmedBusiness,
        ...
        function confirmedClient(params){
            return TokenRestangular.all('prereg/confirmClient').customPOST(params);
        }
        function confirmedBusiness(params){
            return TokenRestangular.all('prereg/confirmedBusiness').customPOST(params);
        }
        function cancelClient(params){
            return TokenRestangular.all('prereg/cancelClient').customPOST(params);
        }
        function cancelBusiness(params){
            return TokenRestangular.all('prereg/cancelBusiness').customPOST(params);
        }

        function getCompanyList(params){
            return TokenRestangular.all('prereg/getCompanyList').customPOST(params);
        }
        function getDistrictList(params){
            return TokenRestangular.all('prereg/getDistrictList').customPOST(params);
        }

        function getOrders(params){
            return TokenRestangular.all('prereg/orders').customPOST(params);
        }
