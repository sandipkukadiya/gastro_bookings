...
(function () {
    ...
    /*@ngNoInject*/
    function PreregController($state, $scope, $rootScope, $filter, PreregService, $translate, moment, $interval,DTOptionsBuilder, DTColumnBuilder) {
        ...
        function getRefreshOrders(){
            ...
            var OrderParams = {
               ...
               PreregService.getOrders(OrderParams).then(function(response){
                  ...
                  vm.orderDetails = response.data1;
