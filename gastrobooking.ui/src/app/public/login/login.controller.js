...
(function () {
    ...
    function LoginController($state, $rootScope, AuthService, appConstant, TokenRestangular, $stateParams) {
        ...
        vm.facebook_login = facebook_login;
        vm.github_login = github_login;
        vm.twitter_login = twitter_login;
        ...
        function facebook_login() {
            location.href = appConstant.onlineApi + "/auth/facebook";           
        };

        function github_login() {
            location.href = appConstant.onlineApi + "/auth/github";            
        };
        function twitter_login() {
            location.href = appConstant.onlineApi + "/auth/twitter";            
        };
    }
